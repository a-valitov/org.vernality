...
enum AdminActionsContainerState {
    case applications
    case approved
}

protocol AdminActionsContainerViewInput: UIViewController {
    var state: AdminActionsContainerState { get set }
    var applications: UIViewController? { get set }
    var approved: UIViewController? { get set }
}

protocol AdminActionsContainerViewOutput {
