...
final class MemberCurrentActionsViewAlphaCell: UITableViewCell {

    static let reuseIdentifier = "MemberCurrentActionsViewAlphaCellReuseIdentifier"
...
// MARK: - Layout
extension MemberCurrentActionsViewAlphaCell {
    private func layout() {
