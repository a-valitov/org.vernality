...
import UIKit
final class AdminApprovedOrganizationsViewAlphaCell: UITableViewCell {

    static let reuseIdentifier = "AdminApprovedOrganizationsViewAlphaCell"
...
extension AdminApprovedOrganizationsViewAlphaCell {
    private func layout() {
    ...
    private func layoutDateLabel(in container: UIView) {
        ...
        NSLayoutConstraint.activate([
            ...
            label.topAnchor.constraint(equalTo: self.organizationNameLabel.bottomAnchor, constant: 8.0)
        ])
    }
}
