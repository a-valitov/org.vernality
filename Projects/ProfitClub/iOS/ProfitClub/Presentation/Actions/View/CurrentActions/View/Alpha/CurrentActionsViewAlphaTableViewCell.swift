...
final class CurrentActionsViewAlphaTableViewCell: UITableViewCell {

    static let reuseIdentifier = "CurrentActionsViewAlphaTableViewCellReuseIdentifier"
...
// MARK: - Layout
extension CurrentActionsViewAlphaTableViewCell {
    private func layout() {
