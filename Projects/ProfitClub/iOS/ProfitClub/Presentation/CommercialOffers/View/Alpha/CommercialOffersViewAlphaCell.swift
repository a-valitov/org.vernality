...
final class CommercialOffersViewAlphaCell: UITableViewCell {

    static let reuseIdentifier = "CommercialOffersViewAlphaCellReuseIdentifier"
...
extension CommercialOffersViewAlphaCell {
    private func layout() {
