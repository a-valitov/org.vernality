...
final class ApproveCurrentActionViewAlpha: UIViewController {
    ...
    private lazy var actionLinkButton: UIButton = {
        let button = UIButton()
        button.addTarget(self, action: #selector(ApproveCurrentActionViewAlpha.actionLinkTouchUpInside(_:)), for: .touchUpInside)
    ...
    private lazy var cancelButton: UIButton = {
        let button = UIButton()
        button.addTarget(self, action: #selector(ApproveCurrentActionViewAlpha.cancelTouchUpInside(_:)), for: .touchUpInside)
        button.translatesAutoresizingMaskIntoConstraints = false
        return button
    }()
...
// MARK: - Layout
extension ApproveCurrentActionViewAlpha {
    private func layout() {
...
extension ApproveCurrentActionViewAlpha: ApproveCurrentActionViewInput {
