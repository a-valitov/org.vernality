...
final class AdminSuppliersApplicationsViewAlphaCell: UITableViewCell {

    static let reuseIdentifier = "AdminSuppliersApplicationsViewAlphaCell"
    ...
    lazy var supplierContactNameLabel: UILabel = {
        let label = UILabel()
...
extension AdminSuppliersApplicationsViewAlphaCell {
    private func layout() {
        layoutSupplierImageView(in: self.contentView)
        layoutSupplierNameLabel(in: self.contentView)
        layoutSupplierContactNameLabel(in: self.contentView)
    ...
    private func layoutDateLabel(in container: UIView) {
        ...
        NSLayoutConstraint.activate([
            ...
            label.topAnchor.constraint(equalTo: self.supplierContactNameLabel.bottomAnchor, constant: 8.0)
        ])
    }
}
